...
void draw_init(int _width, int _height)
{
	...
	verts[12]  = verts[0] + 0.6/DRAW_COORD_WIDTH;
	verts[13]  = verts[1] - 0.6/DRAW_COORD_HEIGHT;

	verts[14]  = verts[2] - 0.6/DRAW_COORD_WIDTH;
	verts[15]  = verts[3] - 0.6/DRAW_COORD_HEIGHT;
	
	verts[16] = verts[4] - 0.6/DRAW_COORD_WIDTH;
	verts[17] = verts[5] + 0.6/DRAW_COORD_HEIGHT;
	


	verts[18] = verts[6] - 0.6/DRAW_COORD_WIDTH;
	verts[19] = verts[7] + 0.6/DRAW_COORD_HEIGHT;
	
	verts[20] = verts[8] + 0.6/DRAW_COORD_WIDTH;
	verts[21] = verts[9] + 0.6/DRAW_COORD_HEIGHT;

	verts[22] = verts[10] + 0.6/DRAW_COORD_WIDTH;
	verts[23] = verts[11] - 0.6/DRAW_COORD_HEIGHT;
	/* */
