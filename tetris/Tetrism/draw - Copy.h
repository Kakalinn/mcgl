...
{
	verts[0]  = i/(DRAW_COORD_WIDTH/2.0) - 1;
	verts[1]  = 1 - j/(DRAW_COORD_HEIGHT/2.0);

	verts[5]  = (i + 1)/(DRAW_COORD_WIDTH/2.0) - 1;
	verts[6]  = 1 - j/(DRAW_COORD_HEIGHT/2.0);
	
	verts[10] = (i + 1)/(DRAW_COORD_WIDTH/2.0) - 1;
	verts[11] = 1 - (j + 1)/(DRAW_COORD_HEIGHT/2.0);
	


	verts[15] = (i + 1)/(DRAW_COORD_WIDTH/2.0) - 1;
	verts[16] = 1 - (j + 1)/(DRAW_COORD_HEIGHT/2.0);
	
	verts[20] = i/(DRAW_COORD_WIDTH/2.0) - 1;
	verts[21] = 1 - (j + 1)/(DRAW_COORD_HEIGHT/2.0);

	verts[25] = i/(DRAW_COORD_WIDTH/2.0) - 1;
	verts[26] = 1 - j/(DRAW_COORD_HEIGHT/2.0);
